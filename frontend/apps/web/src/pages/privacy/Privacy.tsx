  ...
  return (
    <div className="min-h-screen bg-ground">
      <div className="mx-auto max-w-180 px-6 pt-11 pb-16">
        <Link to="/" className="font-display text-sm tracking-wider text-ink-3 hover:text-hextech">
          ← dfgg
        </Link>
        ...
        <Section title="4. 제3자 서비스">
          <p>
            ...
            에서 직접 불러옵니다. 이때 사용자의 IP 주소가 Riot Games에 전달되며, 해당 처리는 Riot
            Games의 개인정보처리방침을 따릅니다.
          </p>
        </Section>
        ...
        <Section title="5. 문의">
          <p>
            개인정보 관련 문의:{' '}
            <a href={`mailto:${CONTACT_EMAIL}`} className="text-hextech hover:underline">
              {CONTACT_EMAIL}
            </a>
          </p>
        </Section>
