  ...
  return (
    <div className='min-h-screen bg-ground'>
      ...
      <div className='mx-auto max-w-full px-6 pt-11 pb-13 text-center'>
        <Link
          to='/'
          className='inline-block text-sm text-ink-3 transition-colors hover:text-accent'
        >
          ← 처음으로
        </Link>

        <h1 className='mt-6 font-display text-4xl leading-none font-bold text-balance sm:text-6xl'>
          다음 판, <em className='text-accent not-italic'>뭘 골라야</em> 이길까
        </h1>
        ...
        <form
          ...
          className='chamfer mx-auto mt-7 flex max-w-135 bg-surface-2 shadow-[inset_0_0_0_1px_var(--color-line)] transition-shadow focus-within:shadow-[inset_0_0_0_1px_var(--color-accent)]'
        >
          ...
          <button
            type='submit'
            className='cursor-pointer bg-accent-strong px-7 font-display text-sm font-bold tracking-[0.16em] text-white uppercase transition-colors hover:bg-accent focus-visible:bg-accent focus-visible:outline-none'
          >
            분석
          </button>
        </form>
