 ...
 * <p>
 *
 * @param counter 이 적들 때문에 가치가 올랐다. counter generator가 후보로 냈고 적별 구매 lift가 문턱을 넘을 때만 채운다
 * @param ally    이 아군들과 맞물린다. 아군에게 작용하는(ALLY) 아이템이고 아군별 승률 lift가 문턱을 넘을 때만 채운다
