...
public class MiningController {
    ...
    public ResponseEntity<EmbeddingTrainingResult> trainEmbeddings(
            ...
            @RequestParam(defaultValue = "2.0") double winWeight,
            @RequestParam(defaultValue = "64") @Min(1) int dimensions,
            @RequestParam(defaultValue = "5") @Min(0) int negativeSamples,
            @RequestParam(defaultValue = "20") @Min(1) int epochs,
            @RequestParam(defaultValue = "0.025") double learningRate,
