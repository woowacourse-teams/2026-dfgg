...
public class CoreBuildSequenceTest {
    ...
    void create_ExcludingBoots_ReturnsFirstThreeCoreItems() {
        // given
        Item boots = new Item(1000L, Map.of("ko-KR", "신발"), List.of("Boots"));
        Item itemA = new Item(1001L, Map.of("ko-KR", "아이템 A"));
        Item itemB = new Item(1002L, Map.of("ko-KR", "아이템 B"));
        Item itemC = new Item(1003L, Map.of("ko-KR", "아이템 C"));
        Item itemD = new Item(1004L, Map.of("ko-KR", "아이템 D"));
