...
class PairLiftCalculatorTest {

    private static final double ALPHA = 1.0;
    private static final int VOCABULARY_SIZE = 159;

    private final PairLiftCalculator calculator = new PairLiftCalculator(ALPHA, VOCABULARY_SIZE);
    ...
    void calculate_WhenBoughtMoreAgainstThisEnemy_LiftExceedsOne() {
        ...
        PairLift lift = calculator.calculate(30, 50, 10, 100);
    ...
    void calculate_WhenBoughtLessAgainstThisEnemy_LiftIsBelowOne() {
        ...
        PairLift lift = calculator.calculate(5, 50, 60, 100);
    ...
    void calculate_WhenSameAsBaseRate_LiftIsAroundOne() {
        // given: 둘 다 30%
        PairLift lift = calculator.calculate(15, 50, 30, 100);
    ...
    void calculate_WhenBaseRateIsZero_LiftStaysFinite() {
        ...
        PairLift lift = calculator.calculate(10, 10, 0, 1000);
    ...
    void calculate_WhenPairSampleIsSmall_ShrinksTowardOne() {
        ...
        PairLift smallSample = calculator.calculate(5, 5, 1, 100);
        // 같은 비율이지만 표본이 20배 큰 경우
        PairLift largeSample = calculator.calculate(100, 100, 20, 2000);
    ...
    void calculate_WhenBaseRateIsFloor_ReportsFloorBaseRateAlongsideHighLift() {
        ...
        PairLift lift = calculator.calculate(8, 10, 1, 1000);
    ...
    void calculate_WhenNoPairGames_LiftIsNeutral() {
        // given
        PairLift lift = calculator.calculate(0, 0, 10, 100);
